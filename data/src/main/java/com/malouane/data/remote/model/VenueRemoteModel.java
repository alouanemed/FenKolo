...
public class VenueRemoteModel {
  ...
  @Json(name = "location") private LocationRemoteModel locationRemoteModel;
  ...
  @Json(name = "venuePage") private VenuePage venuePage;
  @Json(name = "hereNow") private HereNowRemote hereNow;
  @Json(name = "referralId") private String referralId;
  @Json(name = "venueChains") private List<Object> venueChains = null;
  @Json(name = "hasPerk") private Boolean hasPerk;
