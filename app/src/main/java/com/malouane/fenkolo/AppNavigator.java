...
public class AppNavigator {
  ...
  public void navigateToDetails(Activity activity, String id, Pair<View, String> shardViews) {
    Intent intent = new Intent(activity, HomeActivity.class);
    intent.putExtra(EXTRA_VENUE_ID, id);

    Bundle options =
        ActivityOptionsCompat.makeSceneTransitionAnimation(activity, shardViews).toBundle();
